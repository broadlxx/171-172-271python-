...
def Notempty():  #This function is calculating lines
    a=0
    for i in line:
        if i!=None:
            a+=1
    return a
def Numberofwords(): #This function is calculating the number of words
    A=[]
    t=0
    for i in line:
        i=i.replace(","," ")
        ...
        for j in A:
            t+=1
    return t
def Unique():  #This function is calculating the number of the unique words
    global C,d
    A=[]
    B=[]
    C=[]

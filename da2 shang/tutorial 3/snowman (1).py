...
# Define a function that will draw a snowman at a given size at a certain location
def draw_snowman2(screen, x, y, size):
...
# Function to draw a row of snowmen
...
# Function to draw a row of shrinking snowmen
def draw_snowmen2(screen, x, y, size=100):
    if size < 20:
        return
    else:
        draw_snowman2(screen, x, y, size)
        draw_snowmen2(screen, x+size, y, size-10)
